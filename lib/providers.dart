...
import 'package:flu_go_jwt/services/auth/impl/api/auth_dio_gateway.dart' as auth_gateway;
...
import 'package:flu_go_jwt/services/ecomm/product/use_cases/api/api_dio_gateway.dart' as product_gateway;
...
import 'package:flu_go_jwt/services/shared/infraestructure/http/dio_client.dart';
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider<AuthBloc>(
            ...
            create: (context) => AuthBloc(auth_gateway.AuthDioImpl(DioClient().dio))
              ..add(
        ...
        BlocProvider<OrderBloc>(create: (context) => OrderBloc(OrderApiDioUseCase(), StripeImpl())),
      ],
